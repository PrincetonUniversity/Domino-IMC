...
function plotCapacityComparison(data, bin_size, ues_of_interest_only, xaxis_base, is_dl, datapath)
    ...
    if isempty(get(gca, 'Title'))
        title([data.direction ' Capacity: TBS vs Packet vs Target Bitrate (' base_label ')']);
    end
end
