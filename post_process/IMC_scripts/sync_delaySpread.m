...
for i = 1:size(hline_pkt, 1)
    ...
    xEnd = hline_pkt(i, 15);
    yPos = hline_pkt(i, 17)-pkt_idx_adjust;
...
h2_filled = bar(ts_bsr(filled_bsr_idx), tbs_bsr(filled_bsr_idx), 'FaceColor', [0.4660 0.6740 0.1880], 'EdgeColor', [0.4660 0.6740 0.1880], 'LineWidth', 2, 'BarWidth', 0.38);
