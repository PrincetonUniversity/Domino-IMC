---
title: "Zoom 06/20 - 5G, Hi-Cross Traffic - Join"
date: "`r Sys.Date()`"
output:
  html_document:
    df_print: paged
params:
  experiment_name: "zoom-0620-5g-hi-cross"
---
...
join_up %<>%
  mutate(
    ...
    ts_ms_core        = (ts_s_core - ts_offset) * 1000 + ts_us_core / 1000,
    ts_ms_receiver    = (ts_s_receiver - ts_offset) * 1000 + ts_us_receiver / 1000,
    owd_sender_core   = ts_ms_core - ts_ms_sender,
    owd_core_receiver = ts_ms_receiver - ts_ms_core,
